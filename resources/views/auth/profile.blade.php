...
<x-swal />
    ...
    <section class="bg-white rounded-lg p-10 w-full max-w-md relative text-base">
        ...
        <div class="space-y-5">
            ...
            <div class="w-full bg-[#4a7533] text-white text-sm font-semibold rounded-full py-3 cursor-pointer hover:bg-[#3c5e29] transition">
                <a href="{{ route('edit.profile') }}" class="block text-center">Edit Profile</a>
            </div>
            <div class="w-full bg-[#4a7533] text-white text-sm font-semibold rounded-full py-3 cursor-pointer hover:bg-[#3c5e29] transition">
                <a href="{{ route('aboutus') }}" class="block text-center">Tentang Kami</a>
            </div>
            <div class="w-full bg-red-500 text-white text-sm font-semibold rounded-full py-3 cursor-pointer hover:bg-red-600 transition">
                <a href="{{ route('auth.logout') }}" class="block text-center">Logout</a>
            </div>
        </div>
    </section>
</main>
